      ...
      <header className="px-4 sm:px-6 pb-1 pt-6">
        ...
        <div className="flex justify-between items-start">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-gray-500 text-sm">Waktu server: {serverTime}</p>
          </div>
          {getStatusBadge()}
        </div>
      </header>
          ...
          <div className="flex flex-wrap justify-between gap-y-6">
            ...
            <div className="w-[23%]">
              <MenuIcon
                label="Lembur"
                icon={
                  <IconWrapper src="/images/icon-lembur.png" alt="Lembur" />
                }
              />
            </div>
            <div className="w-[23%]">
            ...
            <div className="w-[23%]">
              <MenuIcon
                label="Karyawan"
                icon={
                  <IconWrapper src="/images/icon-karyawan.png" alt="Karyawan" />
                }
              />
            </div>
            <div className="w-[23%]">
              ...
              <div className="flex items-start relative z-10">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Mari rayakan Hari Kemerdekaan Indonesia dengan semangat
                    kebersamaan dan keceriaan! Akan ada be...
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="px-4 py-3 pt-4">
          <div className="flex items-end justify-between max-w-md mx-auto">
            ...
            <div className="flex space-x-8">
              ...
              <NavItem icon={<MessageSquare size={20} />} label="Feed" />
            </div>
            ...
            <div className="flex flex-col items-center px-4">
              ...
              >
                {clockInStatus === "clocked-in" ? "Clock Out" : "Clock In"}
              </span>
            </div>

            {/* Right Side Navigation */}
            <div className="flex space-x-8">
              <NavItem icon={<CheckSquare size={20} />} label="Approval" />
